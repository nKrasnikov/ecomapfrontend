        ...
        <>
            <div className='register_p0'>
                <div className='register_p1'>
                    <Typography variant="h2" fontFamily='Alice' textAlign={'center'}> Регистрация </Typography>
                    <Typography variant="body1" marginBottom={3} fontFamily='Alice' textAlign={'center'}> Введите данные для регистрации </Typography>
                    ...
                    <TextField fullWidth={true} margin='normal' label="Username" variant="outlined" placeholder='Введите ваш логин' onChange={(e) => setUsername(e.target.value)} />
            ...
            <div className='register_p3'>
                <Button type='submit' sx={{ fontFamily: 'Forum', marginTop: 2, marginBottom: 2, width: '60%' }} variant="contained">Регистрация</Button>
