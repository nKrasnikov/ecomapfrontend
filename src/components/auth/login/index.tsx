...
const LoginPage: React.FC<IPropsLogin> = (props: IPropsLogin): JSX.Element => {
    ...
    return (
        <>
            <Typography variant="h2" fontFamily='Alice' textAlign={'center'}> Авторизация </Typography>
            <Typography variant="body1" marginBottom={3} fontFamily='Alice' textAlign={'center'}> Введите ваш логин и пароль </Typography>
            ...
            <Button type='submit' sx={{fontFamily: 'Forum', marginTop: 2, marginBottom: 2, width: '60%'}} variant="contained">Войти</Button>
