    ...
    return (
        <div className='Footer'>
            ...
            <div className='footer_navigation'>
                <span className='map_main_navigation_point'>КАРТА САЙТА</span>
                <span className='map_navigation_point' >Главная страница</span>
                <span className='map_navigation_point'>О нас</span>
                <span className='map_navigation_point'>Контакты</span>
                <span className='map_navigation_point'>Администрация</span>
            </div>
        </div>
    );
};
